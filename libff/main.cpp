...
void printG1(G1<mnt4753_pp> g)
{
  print_array((uint8_t *)g.X().as_bigint().data);
  print_array((uint8_t *)g.Y().as_bigint().data);
  print_array((uint8_t *)g.Z().as_bigint().data);
}
...
int main(int argc, char *argv[])
{
  ...
  while (true)
  {
    ...
    {
      g4_1.emplace_back(read_mnt4g1(inputs));
    }

    std::vector<G2<mnt4753_pp>> g4_2;
    for (size_t i = 0; i < n; ++i)
    {
      g4_2.emplace_back(read_mnt4g2(inputs));
    }

    std::vector<G1<mnt6753_pp>> g6_1;
    for (size_t i = 0; i < n; ++i)
    {
      g6_1.emplace_back(read_mnt6g1(inputs));
    }

    std::vector<G2<mnt6753_pp>> g6_2;
    for (size_t i = 0; i < n; ++i)
    {
      g6_2.emplace_back(read_mnt6g2(inputs));
    }
    ...
    G1<mnt4753_pp> first = g4_1.at(0) + g4_1.at(1) + g4_1.at(2) + g4_1.at(3) + g4_1.at(4) + g4_1.at(5) + g4_1.at(6) + g4_1.at(7);
    //G1<mnt4753_pp> second = g4_1.at(0) + g4_1.at(1) + g4_1.at(2) + g4_1.at(3) + g4_1.at(4) + g4_1.at(5) + g4_1.at(6) + g4_1.at(7);
    printG1(first);
